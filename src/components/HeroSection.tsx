  ...
  return (
    <section className="min-h-screen bg-brand-bg flex flex-col items-center justify-center text-center px-4 pt-16">
      ...
      <a
        href="#product-lineup"
        onClick={handleClick}
        className="mt-10 inline-block px-8 py-4 bg-brand-accent hover:bg-brand-accentHover text-white rounded-full text-lg font-medium transition-all hover:scale-[1.02] active:scale-[0.98]"
      >
        今すぐ注文する →
      </a>
    </section>
